...
**✅ Working Features:**
- **W5 Load Sharing:** Traffic balanced ~65/35 split between dual gateways (19 vs ~10 packets)
- **PM Sensor Integration:** 19 PM readings transmitted via LoRa mesh to Gateway 6674
- **TX Power Fix:** 2 dBm correctly applied (fixed hardcode issue)
- **GPS Integration:** Code functional (no fix indoor, as expected)
- **Trickle:** 85.7% suppression efficiency, I_max=600s reached
...
|---------------|------|---------|----------|--------|
| Node 1 Log | RELAY | 8154 | 2 dBm | ✅ Correct power |
| Node 2 Log | GATEWAY | 6674 | 2 dBm | ✅ Correct power |
