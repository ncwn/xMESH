#!/bin/bash
# Flash script for Protocol 1 - Flooding on macOS
...
echo "======================================="
echo "Flashing Protocol 1 - Node $NODE_ID"
echo "Port: $PORT"
echo "======================================="
...
if [ $? -eq 0 ]; then
    ...
    # Log to session
    echo "$(date): Flashed Protocol 1 to Node $NODE_ID on $PORT" >> ../../.context/session_log.md
    ...
    echo "$(date): FAILED to flash Protocol 1 to Node $NODE_ID" >> ../../.context/session_log.md
fi