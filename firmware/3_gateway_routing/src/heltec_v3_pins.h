...
// PM Sensor (PMS7003) - UART for Particulate Matter
#define PMS_RX_PIN      7   // ESP32 RX (GPIO 7) ← PMS7003 TX (sensor transmits)
#define PMS_TX_PIN      6   // ESP32 TX (GPIO 6) → PMS7003 RX (sensor receives)
#define PMS_BAUD        9600 // UART baud rate

// GPS Module (NEO-M8M-0-10) - UART for GPS
#define GPS_RX_PIN      5   // ESP32 RX (GPIO 5) ← GPS TX (GPS transmits)
#define GPS_TX_PIN      4   // ESP32 TX (GPIO 4) → GPS RX (GPS receives)
#define GPS_BAUD        9600 // UART baud rate (default, can increase to 38400)
...
#define DEFAULT_LORA_TX_POWER    2     // dBm (indoor runs)
